...
```r
  ...
  #medium regions and their coverage
    ...
    kpText(kp,  y=0.4, x=0, data.panel = 2, r0=0.2, r1=0, col="#444444", label="30x", cex=0.8, pos=2)
```

```
## Error in prepareParameters2("kpText", karyoplot = karyoplot, data = data, : chr must be specified, either by the 'chr' parameter or by providing a 'data' object
```
