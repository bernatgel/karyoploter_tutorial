...
```{r Figure2, message=FALSE, warning=FALSE, fig.height=10}
kp <- plotKaryotype(plot.type=2, chromosomes=c("chr1", "chr2"))
kpDataBackground(kp)
kpDataBackground(kp, data.panel = 2)
...
```{r Figure3, message=FALSE, warning=FALSE, fig.height=10}
...
```{r Figure4, message=FALSE, warning=FALSE, fig.height=10}
